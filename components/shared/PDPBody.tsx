        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            >
              ...
              {discount > 0 && (
                <span
                  className={`px-2.5 py-0.5 text-xs font-black ${isMinimal
                  ...
                  {product.variants.map((v) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-4 py-2 text-xs font-bold border transition flex items-center gap-2 cursor-pointer ${isMinimal
                          ? 'rounded-none'
                          : isLuxe
                            ? 'rounded-none'
                            : isMincom
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {(isCouponsExpanded ? coupons : coupons.slice(0, 4)).map((coupon) => {
                    ...
                    return (
                      <div
                        key={coupon.id}
                        className={`p-3 border border-dashed flex flex-col justify-between gap-2.5 transition hover:shadow-sm ${isMinimal ? 'rounded-none' : isLuxe ? 'rounded-none' : 'rounded-xl'
                          }`}
                        style={{
              ...
              {isOutOfStock ? (
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-center text-xs text-rose-500 font-semibold">
                    This item is currently sold out. Get alerted instantly when restocked.
                  </p>
                </div>
              ) : (
              ...
              >
                {(['description', 'specs', 'reviews'] as const).map((tab) => (
                  <button
                    ...
                    className={`pb-4 text-sm font-bold tracking-wide transition-all border-b-2 cursor-pointer ${isLuxe
                ...
                {activeTab === 'specs' && (
                  ...
                  >
                    {[
                      ...
                      <div
                        key={row.label}
                        className={`py-3.5 px-4 flex justify-between items-center text-xs ${idx % 2 === 0 ? 'bg-black/[0.01] dark:bg-white/[0.01]' : ''
                          }`}
                      ...
                      <div className="md:col-span-3 text-center md:text-right">
                        {isAuthenticated ? (
                          <button
                            ...
                            className={`w-full sm:w-auto px-5 py-3 font-bold text-xs text-white shadow-lg transition hover:opacity-90 cursor-pointer ${isMinimal
                      ...
                      {isReviewsLoading ? (
                            ...
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className={`text-xs font-semibold px-2.5 py-1 flex items-center gap-1 transition cursor-pointer ${radiusPill} ${hasUserLiked(rev)
                        ...
                        >
                          ...
                          {isAuthenticated ? (
                            <button
                              onClick={openWriteReview}
                              className={`px-5 py-2.5 text-xs font-bold text-white shadow cursor-pointer ${isMinimal
