    ...
    <>
      ...
      <header
        ...
        style={{
          ...
          zIndex: 40,
          borderBottom:
            '1px solid color-mix(in srgb, var(--sf-primary) 25%, color-mix(in srgb, var(--sf-text) 8%, transparent))',
        }}
      >
            ...
            >
              {isAuthenticated ? (
                <div className="space-y-2">
                  <p
                    className="text-[11px] tracking-wider uppercase opacity-60 truncate"
                    style={{ color: 'var(--sf-text)' }}
                  >
