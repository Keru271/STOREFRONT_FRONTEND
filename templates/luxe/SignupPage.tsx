    ...
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--sf-bg)' }}>
      ...
      >
        ...
        <div className="relative z-10">
          <Link href="/">
            <div>
              <span className="text-xl font-bold tracking-[0.25em] uppercase text-white">
                {theme.storeName}
              </span>
              <span
        ...
        <div className="relative z-10">
          <h2
            className="text-5xl font-bold text-white leading-none mb-6"
            ...
            {benefits.map((benefit) => (
              <div key={benefit} className="flex items-center gap-3">
                <div
                  ...
                  style={{ border: '1px solid var(--sf-primary)' }}
                >
                  <svg
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 py-12 overflow-y-auto">
        <div className="lg:hidden mb-10 text-center">
          ...
          <span
            className="text-xs tracking-[0.4em] uppercase block mt-0.5"
            style={{ color: 'var(--sf-primary)' }}
          >
            Premium
          </span>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-light" style={{ color: 'var(--sf-text)' }}>
              Request Access
            </h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {fields.map((field) => (
              <div key={field.id}>
                <label
                  className="text-xs tracking-[0.15em] uppercase block mb-3 font-light"
                ...
                <input
                  ...
                  onFocus={(e) =>
                    ((e.target as HTMLInputElement).style.borderColor = 'var(--sf-primary)')
                  }
                  onBlur={(e) =>
            ...
            <label className="flex items-start gap-3 cursor-pointer pt-2 group">
              ...
              >
                I wish to receive private salon invitations, new collection previews, and
