...
export default function DemoFooter() {
  ...
  return (
    <footer
      className="w-full bg-[#161616] text-[#a0a0a0] pt-16 pb-12 border-t border-[#262626]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-14 border-b border-[#282828]">
          ...
          <div className="lg:col-span-4 space-y-5">
            <div className="text-white">
              <DemoLogo className="h-9 brightness-0 invert" />
            </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">Catalog</h4>
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">Studio</h4>
            <ul className="space-y-2.5 text-xs font-medium">
              <li>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded-lg bg-[#222] border border-[#333] text-white placeholder:text-[#666] text-xs focus:outline-none focus:border-[#ff9638] transition"
              />
              <button
                type="submit"
                className="px-5 py-2.5 rounded-lg bg-[#ff9638] hover:bg-[#e07f28] text-white text-xs font-bold transition shadow cursor-pointer"
              >
                Join
              </button>
            </form>
