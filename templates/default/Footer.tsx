      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section}>
              <h4 className="font-semibold text-sm tracking-widest uppercase mb-4" style={{ color: 'rgba(255,255,255,0.4)' }}>
                {section}
              </h4>
        ...
        >
          ...
          <div className="flex gap-4">
            {['Terms', 'Privacy', 'Cookies'].map((t) => (
              <Link key={t} href={`/${t.toLowerCase()}`} className="text-xs transition-colors" style={{ color: 'rgba(255,255,255,0.4)' }}>
                {t}
              </Link>
            ))}
          </div>
