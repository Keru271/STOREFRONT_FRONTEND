...
export default function DefaultSignupPage({ theme }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--sf-bg)' }}>
      ...
      >
        <div
          className="absolute top-0 left-0 w-96 h-96 rounded-full opacity-15 blur-3xl"
      ...
      <div className="flex-1 lg:max-w-lg flex flex-col justify-center px-6 sm:px-12 py-12 overflow-y-auto">
        <div className="lg:hidden mb-8">
          <Link href="/">
            <span className="text-xl font-bold" style={{ color: 'var(--sf-primary)' }}>
              {theme.storeName}
            </span>
          </Link>
        </div>
        ...
        <div className="max-w-sm w-full mx-auto">
          <h2 className="text-3xl font-bold mb-1" style={{ color: 'var(--sf-text)' }}>
            Create account
          </h2>
          <p
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div
                ...
                style={{
                  border: agreed
                    ? 'none'
                    : '1.5px solid color-mix(in srgb, var(--sf-text) 30%, transparent)',
              ...
              >
                I agree to the{' '}
                <Link href="/terms" className="font-medium" style={{ color: 'var(--sf-primary)' }}>
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span
                ...
                style={{ color: 'color-mix(in srgb, var(--sf-text) 60%, transparent)' }}
              >
                Keep me updated with exclusive member discounts, promo rewards, and product launches
                via email & SMS.
              </span>
            </label>
