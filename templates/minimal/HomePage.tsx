      ...
      <main className="flex-1">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                ...
                for the
                <br />
                <em className="not-italic font-bold" style={{ color: 'var(--sf-primary)' }}>
                  essentials.
                </em>
              </h1>
              <p
                className="text-base font-light leading-relaxed mb-10 max-w-sm"
            ...
            <div className="relative">
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center">
                      <div
                        ...
                        style={{
                          backgroundColor: 'color-mix(in srgb, var(--sf-primary) 20%, transparent)',
                        }}
                      />
                      <div
                        className="w-32 h-2 rounded mx-auto mb-2"
                        style={{
              ...
              >
                ...
                <p className="text-lg font-bold" style={{ color: 'var(--sf-text)' }}>
                  On all orders
                </p>
              </div>
            </div>
        ...
        {featuredCollections.length > 0 && (
          <section className="max-w-6xl mx-auto px-6 py-20">
            <div className="flex justify-between items-baseline mb-12">
              <h2 className="text-3xl font-extralight" style={{ color: 'var(--sf-text)' }}>
                Collections
              </h2>
              <Link
                href="/collections"
          ...
          <section className="max-w-6xl mx-auto px-6 py-10">
            <div className="flex flex-wrap gap-2">
              <Link
                ...
                style={{ color: 'var(--sf-bg)', backgroundColor: 'var(--sf-text)' }}
              >
                All
              </Link>
              {categories.map((cat) => (
        ...
        >
          <blockquote className="max-w-2xl mx-auto">
            <p
              className="text-2xl lg:text-3xl font-extralight italic leading-relaxed mb-6"
              style={{ color: 'var(--sf-text)' }}
            >
