      ...
      <Link href={productHref} className="block">
        ...
        >
          ...
          <div className="absolute top-3 right-3 flex flex-col gap-1 z-10">
            ...
            {discount > 0 && (
              <span
                className="text-xs font-semibold px-2 py-0.5 rounded bg-white/80 dark:bg-black/80"
        ...
        <div>
          ...
          <p
            className="text-sm font-light mb-2 transition-opacity group-hover:opacity-60"
            style={{ color: 'var(--sf-text)' }}
          >
            {product.name}
          </p>
